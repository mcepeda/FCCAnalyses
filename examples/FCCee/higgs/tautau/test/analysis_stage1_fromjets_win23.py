...
outputDir   = "/eos/user/c/cepeda/FCCeeTests/Taus/testingFeb16_tests"
...
#               .Define("zed_leptonic_recoil",  "ReconstructedParticle::recoilBuilder(240)(zed_leptonic)")
               ...
               .Define("Particle_daughter","Take(Parent_indices,Particle.daughters_begin)")
               .Define("Particle_parent_PDG","Take(Particle.PDG,Particle_parent)")
               .Define("Particle_daughter_PDG","Take(Particle.PDG,Particle_daughter)")

               #.Define("Particle_indices_Select","Particle_indices[  abs(Particle.PDG)==15 ]")
               .Define("Particle_indices_Select","Particle_indices[(abs(Particle.PDG)>=11 && abs(Particle.PDG)<=16) || abs(Particle.PDG)<=6 || (abs(Particle.PDG)>=23 && abs(Particle.PDG)<=25)]")
 
               .Define("GenPart_PDG","Take(Particle.PDG,Particle_indices_Select)")
               .Define("GenPart_px","Take(Particle.momentum.x,Particle_indices_Select)")
               .Define("GenPart_py","Take(Particle.momentum.y,Particle_indices_Select)")
               .Define("GenPart_pz","Take(Particle.momentum.z,Particle_indices_Select)")
               .Define("GenPart_pt","sqrt(GenPart_px*GenPart_px+GenPart_py*GenPart_py)")
               .Define("GenPart_charge","Take(Particle.charge,Particle_indices_Select)")
               .Define("GenPart_momPDG","Take(Particle_parent_PDG,Particle_indices_Select)")

               .Define("GenPart_mass","Take(Particle.mass,Particle_indices_Select)")
               .Define("GenPart_status","Take(Particle.generatorStatus,Particle_indices_Select)")

               .Define("GenPart_VisP4", "myUtils::VisGenP4(Particle_indices_Select, Particle, Daughter_indices,0)")
               .Define("GenPart_type", "myUtils::GenTauType(Particle_indices_Select, Particle, Daughter_indices,0)")

               #.Define("GenPart_VisPx", "GenPart_VisP4.X()")
               #.Define("GenPart_VisPy", "GenPart_VisP4.Y")
               #.Define("GenPart_VisPz", "GenPart_VisP4.Z")
               #.Define("GenPart_VisPt", "GenPart_VisP4.T")
               #.Define("GenPart_VisTheta", "GenPart_VisP4.Theta")
               #.Define("GenPart_VisPhi", "GenPart_VisP4.Phi")
               #.Define("GenPart_VisMass", "GenPart_VisP4.Mass")
               .Define("NGenPart","(UInt_t)GenPart_VisP4.size()")
...
#               .Define("Jets_recluster", "JetClustering::clustering_ee_genkt(0.3, 0, 0, 0, 0, -1)(pseudo_jets)")
...
#                "JetReRun_p4",
                ...
                "Simulated_sqrts",
                "GenPart_px","GenPart_py","GenPart_pz","GenPart_mass","GenPart_PDG",#"GenPart_parent"# ,
                "GenPart_pt","GenPart_charge","GenPart_momPDG",

                #"GenPart_VisPx", "GenPart_VisPy", "GenPart_VisPz", "GenPart_VisPt","GenPart_VisPhi", "GenPart_VisTheta" , "GenPart_VisMass",
                  "GenPart_VisP4","GenPart_type","NGenPart",
